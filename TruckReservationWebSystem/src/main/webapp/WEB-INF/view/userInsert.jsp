...
String entepriseName = (String)request.getAttribute("entepriseName");
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-warning text-white">
                    新規ユーザー登録(<%=entepriseName %>)
                </div>
                <div class="card-body">
                    <form action="UserInsert" method="post">
                        <div class="form-group">
                            <label for="userId">ユーザー名</label>
                            <input type="text" class="form-control" id="userName" name="userName" placeholder="ユーザー名を入力してください。">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="userNumber" name="userNumber" placeholder="電話番号を入力してください">
                            <p id="userNumberError" class="text-danger"></p>
                        </div>
                        
                        <div class="form-group">
                            <label for="userEmail">メールアドレス</label>
                            <input type="email" class="form-control" id="userEmail" name="userEmail" placeholder="メールアドレスを入力してください">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(event) {
            ...
            if (authorityIdValue.length < 1) {
            	authorityIdError.textContent = "権限を選択してください。";
                isValid = false;
            } else {
