...
<nav class="navbar navbar-expand-lg navbar-light">
    <a class="navbar-brand" href="/TruckReservationWebSystem/Index">
        トラック予約Webシステム
    </a>
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-6 text-center">
            <form action="Logout" method="get">
                <button type="submit" class="btn btn-warning btn-block" onclick="return logout();">ログアウト</button>
            </form>
        </div>
    </div>
</div>
